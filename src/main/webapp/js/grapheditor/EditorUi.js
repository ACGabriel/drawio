 ...
 */
 ...
 EditorUi.prototype.initCanvas = function()
 {
	 ...
	 graph.view.getBackgroundPageBounds = function()
	 {
		 ...
		 var bounds = new mxRectangle(this.scale * (this.translate.x + layout.x * page.width),
				 this.scale * (this.translate.y + layout.y * page.height) + 10,
 ...
 */
 ...
 EditorUi.prototype.refresh = function(sizeDidChange)
 {
	 ...
	 if (this.menubar != null && urlParams['showMenu'] == 1)
	 {
		 this.menubarContainer.style.height = this.menubarHeight + 'px';
		 tmp += this.menubarHeight;
	 }
	 
	 if (this.toolbar != null && urlParams['showToolbar'] == 1)
	 {
	 ...
	 var contLeft = (this.hsplit && this.hsplit.parentNode != null) ? (effHsplitPosition + this.splitSize) : 0;
 ...
 EditorUi.prototype.createUi = function()
 {
	 ...
	 // HSplit
	 if (this.sidebar != null && this.hsplit)
	 {
 ...
 EditorUi.prototype.destroy = function()
 {
	 ...
	 if (urlParams['showMenu'] == 1) {
		 c.push(this.menubarContainer);
		 
	 }
 
	 if (urlParams['showToolbar'] == 1) {
		 c.push(this.toolbarContainer);
	 }
 
	 if (urlParams['showSidebarContainer'] == 1) {
		 c.push(this.sidebarContainer);
		 c.push(this.hsplit);
		 //c.push(this.sidebarFooterContainer);
	 }
 
	 if (urlParams['showFormatContainer'] == 1) {
		 c.push(this.formatContainer);
	 }
 
	 c.push(this.diagramContainer);
	 c.push(this.footerContainer);
	 c.push(this.chromelessToolbar);
	 c.push(this.layersDialog);
